...
!!! danger "Token security"
    For debugging purposes, you can decode tokens on [jwt.io](https://jwt.io) to inspect claims and issuer fields. Never share production tokens or paste them into third-party websites.
